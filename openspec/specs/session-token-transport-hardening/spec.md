# session-token-transport-hardening Specification

## Purpose
Define safe private-beta session transport rules so durable auth tokens are not leaked through browser-visible URLs.
