# private-beta-access-control Specification

## Purpose
Define the authorization rules that protect league social mutations and user-scoped score or badge data during the private beta.
