# local-beta-boundary-hardening Specification

## Purpose
Define the loopback-oriented network boundary and operator checklist required for the local-tunnel private beta topology.
